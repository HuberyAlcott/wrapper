...
public class HttpTools {
  ...
  /** 获取访问者的ip地址 注：要外网访问才能获取到外网地址，如果你在局域网甚至本机上访问，获得的是内网或者本机的ip */
  public static String parseHttpAddress(HttpServletRequest request) {
  ...
  public static IpVo getIpVo(String ip) {
    ...
    try {
      ...
      BufferedReader in =
          new BufferedReader(new InputStreamReader(urlConnection.getInputStream(), "GBK"));
  ...
  public static IpVo getIpVoByRequest(HttpServletRequest request) {
    return getIpVo(parseHttpAddress(request));
  }
